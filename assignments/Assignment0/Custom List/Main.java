...
// i did not handle to add an element to the array after its grown in size. This is why 23 is not added to the array after it grew.
        CustomArrayList<Integer> myArray = new CustomArrayList<>();
        myArray.add(21);
        myArray.add(22);
        myArray.add(23);
        myArray.add(24);
